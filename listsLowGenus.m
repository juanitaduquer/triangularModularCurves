...
NewList0 := [
    [ 2, 4, 6, 5, 5, -1 ], [ 4, 4, 5, 5, 5, -1 ], [ 2, 3, 7, 7, 7, 1 ], [ 2, 3, 8, 7, 7, -1 ], [ 2, 4, 6, 7, 7, -1 ],
    [ 2, 6, 7, 7, 7, -1 ], [ 3, 3, 4, 7, 7, 1 ], [ 3, 3, 7, 7, 7, 1 ], [ 2, 8, 8, 3, 9, -1 ], [ 3, 3, 4, 3, 9, 1 ],
    [ 4, 4, 4, 3, 9, 1 ], [ 2, 3, 10, 11, 11, -1 ], [ 2, 4, 5, 11, 11, -1 ], [ 2, 5, 10, 11, 11, -1 ], [ 2, 3, 7, 13, 13, 1 ],
    [ 2, 3, 13, 13, 13, 1 ], [ 2, 4, 12, 13, 13, -1 ], [ 2, 6, 6, 13, 13, 1 ], [ 3, 3, 6, 13, 13, 1 ], [ 2, 3, 8, 17, 17, 1 ],
    [ 2, 4, 8, 17, 17, 1 ], [ 2, 3, 9, 19, 19, 1 ], [ 2, 3, 18, 19, 19, -1 ], [ 2, 3, 12, 5, 25, 1 ], [ 3, 3, 4, 5, 25, 1 ],
    [ 2, 3, 7, 29, 29, 1 ], [ 2, 3, 10, 31, 31, -1 ], [ 2, 3, 9, 37, 37, 1 ], [ 2, 4, 5, 41, 41, 1 ], [ 2, 3, 7, 43, 43, 1 ]
];

Problem0 := [
    [ 2, 6, 6, 7 ], [ 2, 4, 8, 3 ], [ 2, 4, 9, 3 ], [ 2, 8, 9, 3 ], [ 2, 3, 12, 13 ], [ 2, 4, 6, 13 ], [ 2, 3, 8, 5 ], [ 2, 4, 9, 3 ]
];
